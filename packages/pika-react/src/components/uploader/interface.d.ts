...
export interface PkUploaderProps extends PkComponent {
    className: string;
    customStyle: string;
    /**
     ...
     * 点击图片触发的回调
     */
    onImageClick?: (index: number, file: Record<string, any>) => void;
    /**
     * 选择失败触发的回调
     */
...
declare const PkImagePicker: ComponentClass<PkUploaderProps>;

export default PkImagePicker;
